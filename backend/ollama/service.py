...
def analyze_evidence(
    question: str, summary: str, rag_context: str, sql_context: str = "", view_context: str = ""
) -> str:
    messages = build_analysis_messages(question, summary, rag_context, sql_context, view_context)
